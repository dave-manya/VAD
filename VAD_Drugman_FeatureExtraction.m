function [MatFeat,t] = VAD_Drugman_FeatureExtraction(wave,Fs,no)
...
%
% Example
%  Please see the "Demo_VAD.m" example file, or the "VAD_Drugman.m" function
%
% References
...
%  [3] T.Drugman, Y. Stylianou, "Maximum Voiced Frequency Estimation:
...
while Stop<=length(wave)
    ...
    XSpec=fft(Seg,2048);
    XSpec=20*log10(abs(XSpec(1:1024)));  %The problem is here. FFT is negative values. The log gives -Inf 
